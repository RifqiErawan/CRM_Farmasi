...
<!-- 
    ...
    <label class="col-sm-2 col-form-label" >Rata-rata Obat Sejenis</label>
         <div class="col-sm-10">
             <input class="form-control" type="number" id="rupiah" name="jumlah_hari_praktek" placeholder="Yang diresepkan ke Pasien" required="required">
        </div>
    </div>
    ...
    <label class="col-sm-2 col-form-label" >Harga Obat </label>
         <div class="col-sm-10">
             <input class="form-control" type="number"  id="rupiah" name="harga_obat" placeholder="Yang akan ditawarkan medrep" required="required">
        </div>
    </div>
